...
require './lib/post_slack.rb'

CALENDER_ID = ''
TIMETREE_ACCESS_TOKEN = ''
TIMETREE_API_URL = "https://timetreeapis.com/calendars/#{CALENDER_ID}/upcoming_events?timezone=Asia/Tokyo&days=7&include=creator,label,attendees"
TIMETREE_URL = "https://timetreeapp.com/calendars/#{CALENDER_ID}/events/"
...
PostSlack.new(message: message).post
